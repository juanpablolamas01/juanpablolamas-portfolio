                        ...
                        <div className="col-xl-12 col-lg-12">
                            <SlideUp>
                                <div className="section-title text-center">
                                    ...
                                    <p>A selection of product and web projects focused on scalable SaaS platforms, 
                                    growth-driven experiences, and high-performing systems, built through strong product thinking and close collaboration with engineering.</p>
                                </div>
                            </SlideUp>
                        </div>
                    </div>
...
const Card = ({ category, title, src, animationClass, id }) => {
    return (
        <div className={`col-lg-6 col-md-6 item branding game ${animationClass}`}>
            <SlideUp delay={id}>
                <div className="project-item style-two">
                    <div className="project-image">
                        <Image width={383} height={249} sizes='100vw' style={{width:"100%", height:"auto"}} src={src} alt="Project" />
                        <Link href={`/single-project/${id}`} className="details-btn"><RiArrowRightUpLine /> </Link>
                    </div>
